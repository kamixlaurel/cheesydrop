    ...
    return (
      <View>
        ...
        onRequestClose={() => this.setState({ loginVisible: true})}>
          <View 
            style={{backgroundColor: '#f3f3f3', height: 800}} 
            font-family='Segoe UI'>
              ...
              <Button
                ...
                color= '#1f1f1f' title='LOGIN' fontWeight='bold'/>
              <FormInput 
                onChangeText={text => this.setState({ usernameInput: text })} 
                value={this.state.usernameInput} 
                style={{backgroundColor: '#e2e2e2', width: 301, height: 35, left:13, top: -178, padding: 8}} 
            ...
            <View style={{height: 200, width: 195, top: -25}}>
              <Button 
                onPress={() => this.setState({registerVisible: true, loginVisible: false})} 
                buttonStyle={{width: 140, left:13, backgroundColor: '#ebcc21'}} 
                color= '#2f2f2f' title='Register as Driver'/>
            </View>
            <View style={{height: 200, width: 195, top: -225, left: 160}}>
              <Button 
                onPress={() => this.setState({registerVisible: true, loginVisible: false})} 
                buttonStyle={{width: 140, left:13, backgroundColor: '#ebcc21'}} 
                color= '#2f2f2f'title='Register as Parent'/>
            </View>
          </View>
        </Modal>
        ...
        <Modal 
          ...
          onRequestClose={() => this.setState({ loginVisible: true, registerVisible: false})}>
            <View style={{backgroundColor: '#f3f3f3'}}>
              <View style={{backgroundColor: '#f3f3f3', height: 450, top: 0}}>
                ...
                <FormInput 
                  onChangeText={text => this.setState({ usernameInput: text })} 
                  value={this.state.usernameInput} 
                  style={{backgroundColor: '#e2e2e2', width: 295, height: 35, left:16, top: -315, padding: 8}} 
                  underlineColorAndroid='transparent'
                  />
                <FormInput 
                ...
                <FormInput 
                  ...
                  style={{backgroundColor: '#e2e2e2', width: 295, height: 35, left:16, top: -260, padding: 8}} 
                  underlineColorAndroid='transparent'
                />
            </View>
...
>>>>>>> 2a1d17056723f4f97a1e580506fc1684d03ff8d2
}